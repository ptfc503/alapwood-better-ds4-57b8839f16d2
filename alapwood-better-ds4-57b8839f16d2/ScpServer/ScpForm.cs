...
namespace ScpServer 
{
    public partial class ScpForm : Form 
    {
        ...
        protected void Form_Load(object sender, EventArgs e) 
        {
            ...
            Global.Load();
            deviceSharingModeIsExclusive.Checked = Global.getDeviceSharingModeIsExclusive();
        ...
        private void deviceSharingModeIsExclusive_CheckedChanged(object sender, EventArgs e)
        {
            Global.setDeviceSharingModeIsExclusive(deviceSharingModeIsExclusive.Checked);
        }
    }
