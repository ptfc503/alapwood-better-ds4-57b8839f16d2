    ...
    public partial class ScpDevice : Component 
    {
        ...
        protected virtual Boolean Find(Guid Target, ref String Path, Int32 Instance = 0) 
        {
            ...
            try
            {
                ...
                Int32 detailSize = 0, memberIndex = 0;
                ...
                {
                    SetupDiGetDeviceInterfaceDetail(deviceInfoSet, ref DeviceInterfaceData, IntPtr.Zero, 0, ref detailSize, ref da);
                    {
                        detailDataBuffer = Marshal.AllocHGlobal(detailSize);

                        Marshal.WriteInt32(detailDataBuffer, (IntPtr.Size == 4) ? (4 + Marshal.SystemDefaultCharSize) : 8);

                        if (SetupDiGetDeviceInterfaceDetail(deviceInfoSet, ref DeviceInterfaceData, detailDataBuffer, detailSize, ref detailSize, ref da))
                        {
